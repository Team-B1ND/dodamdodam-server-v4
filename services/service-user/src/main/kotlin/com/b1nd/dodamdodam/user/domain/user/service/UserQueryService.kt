...
class UserQueryService(
    ...
    fun search(keyword: String?, roles: List<RoleType>?, generationOnly: Boolean?, status: List<StatusType>?, pageable: Pageable): UserSearchPageCommand {
        val results = userQueryRepository.searchUsers(keyword, roles, generationOnly, status, pageable)
