...
fun NightStudyEntity.toProjectNightStudyResponse(isLeader: Boolean) = ProjectNightStudyResponse(
    ...
    isLeader = isLeader,
    status = status,
    room = room?.let { ProjectNightStudyResponse.RoomInfo(id = it.publicId!!, name = it.name) },
)
...
fun NightStudyEntity.toOpenApiNightStudyResponse(
    ...
    rejectionReason = rejectionReason,
    type = type,
    room = room?.let { NightStudyApplicationResponse.RoomInfo(id = it.publicId!!, name = it.name) },
)
